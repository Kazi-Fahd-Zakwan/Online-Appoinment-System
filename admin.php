...
<body style="background-color: #635d96;">
    <?php
    ...
    <div class="container">
        <div class="login-container" style="width: 70%">
            <div id="output"></div> 
            <h3 style="color: #00bfff;">Welcome Admin!</h3><br>
            <form action="" method="post"><input type="submit" name="poweroff" style="margin-bottom: 10px" value="Logout"></form>
            <div class="form-box">
                <form action="" method="post">
                    <input type="date" name="date" placeholder="pick a date" required="required" value="<?php echo $_SESSION['date'];?>"><br>
                    <button name="load" style="margin-top:10px" type="submit">Load</button>
                </form>
            </div>
            <form action="" method="POST">
                <table style="margin-top: 10px;">
                    <tr>
                        <th>Senior Mechanics Names</th>
                        <th>Slot 01</th>
                        <th>Slot 02</th>
                        <th>Slot 03</th>
                        <th>Slot 04</th>
            ...
            <form action="" method="POST">
            <fieldset>
            <legend><h2>Client's Information:</h2><br></legend>
